...
@inject("homeStore")
@observer
class DetailAdminAgent extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <AwareScroll>
        ...
        <TouchableOpacity onPress={this.acceptAgent}>
          ...
          >
            <MediumText color={colors.WHITE_COLOR}>{"Accept Agent"}</MediumText>
          </ViewCenter>
        </TouchableOpacity>
  ...
  acceptAgent() {
    ...
    if (params) {
      navigation.replace("AcceptAgent", {
...
export default DetailAdminAgent;
